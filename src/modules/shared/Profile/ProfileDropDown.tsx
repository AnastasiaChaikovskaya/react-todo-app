    ...
    <DropdownMenu>
      <DropdownMenuTrigger className="flex justify-center items-center">
        <div className="flex gap-1 items-center md:gap-3">
          ...
          <div className=" flex justify-center items-center bg-blue-800 h-9 w-9 rounded-full">
            <span className="relative left-[0.5px] text-stone-100 font-bold text-base leading-none">{`${firstName[0]}${lastName[0]}`}</span>
          </div>
        </div>
      </DropdownMenuTrigger>
      <DropdownMenuContent>
